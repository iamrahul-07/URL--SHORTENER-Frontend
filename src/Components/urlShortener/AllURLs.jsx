...
const AllURLs = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen p-6 flex justify-center mt-16">
      <div className="w-full min-w-5xl bg-white/90 backdrop-blur-md shadow-2xl rounded-3xl p-6 border border-blue-100 overflow-y-auto max-h-[80vh]">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-blue-100 text-gray-800 text-left">
                <th className="p-4 border-b text-center font-bold text-xl w-[70%]">Original URL</th>
                <th className="p-4 border-b font-bold text-xl text-center w-[30%]">Short URL</th>
              </tr>
            </thead>
            <tbody>
              {urls.map((item, index) => (
